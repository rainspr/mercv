...
_riot2.default.tag2('approot', '<h4>{title}</h4>', '', '', function (opts) {
...
//riotのコンパイラで出力されたtags.js

_riot2.default.mount('approot');
},{"riot":6,"./tags":7}],0:[function(require,module,exports) {
var global = (1, eval)('this');
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  var ws = new WebSocket('ws://localhost:36854/');
